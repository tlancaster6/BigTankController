...
#
# Connect to a camera
requests.post(watchtowerurl+'/api/cameras/action', data = {'Id': camid, 'Action': 'CONNECT', 'Iface': '', 'Config': resolution, 'Codec': codec, 'Annotation': anno, 'Segtime': segment}, verify=False)
...
requests.post(watchtowerurl+'/api/cameras/action', data = {'Id': camid, 'Action': 'DISCONNECT'}, verify=False)
print("Disconnected")
